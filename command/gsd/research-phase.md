---
description: Research how to implement a phase before planning [phase]
subtask: true
---
...
This is for niche/complex domains where the LLM's training data is sparse or outdated. Research discovers:
...
<execution_context>
@{{GSD_PATH}}/workflows/research-phase.md
@{{GSD_PATH}}/templates/research.md
@{{GSD_PATH}}/references/research-pitfalls.md
</execution_context>
...
- Commodity features the LLM handles well
</when_to_use>

<success_criteria>
- [ ] Phase validated against roadmap
- [ ] Domain/ecosystem identified from phase description
- [ ] Comprehensive research executed (Context7 + official docs)
