...
**Note:** OpenCode maintains session context differently than Claude Code. This command creates an explicit handoff file for cases where you want to document the exact state for future sessions or other developers.
</objective>
...
Be specific enough for a fresh LLM session to understand immediately.
</step>
