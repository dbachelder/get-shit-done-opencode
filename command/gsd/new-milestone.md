---
description: Create a new milestone with phases for an existing project [milestone name]
---
...
<execution_context>
@{{GSD_PATH}}/workflows/create-milestone.md
...
What should this milestone be called?

1. v[next version] Features
2. v[next version] Improvements
3. Let me name it
