...
1. Close resolved issues - Move to Closed Enhancements section
2. Review each first - Show details before closing

**If urgent issues exist:**

3. Insert urgent phase - Create phase to address urgent issues (/gsd/insert-phase)
4. Add to current plan - Include in next plan being created
5. Defer anyway - Keep as-is despite urgency

**If natural fits exist:**

6. Note for phase planning - Will be picked up during /gsd/plan-phase
7. Add explicit reminder - Update issue with "Include in Phase X"

**Always include:**

8. Done for now - Exit without changes
