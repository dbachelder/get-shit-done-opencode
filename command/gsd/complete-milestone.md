---
description: Archive completed milestone and prepare for next version [version]
---

<objective>
Mark milestone complete, archive to milestones/, and update ROADMAP.md.
...
- @{{GSD_PATH}}/workflows/complete-milestone.md (main workflow)
- @{{GSD_PATH}}/templates/milestone-archive.md (archive template)
</execution_context>
