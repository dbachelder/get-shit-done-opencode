---
description: Insert urgent work as decimal phase (e.g., 72.1) between existing phases [after] [description]
---
...
**Phase {decimal_phase}: {Description}** — Plan the inserted urgent phase
