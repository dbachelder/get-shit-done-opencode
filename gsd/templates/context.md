...
- Codebase patterns (the LLM reads the code)
- Technical risks (the LLM identifies during research)
- Implementation constraints (the LLM figures out)
- Success metrics (the LLM infers from the work)
