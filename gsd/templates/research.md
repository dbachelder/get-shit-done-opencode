...
**Purpose:** Document what the LLM needs to know to implement a phase well - not just "which library" but "how do experts build this."
...
mcp__context7__resolve-library-id topic="three.js"

# Then fetch specific documentation
mcp__context7__get-library-docs libraryId="/mrdoob/three.js" topic="instanced mesh performance"
```
...
### Primary (HIGH confidence)
- Context7: /pmndrs/react-three-fiber - getting started, hooks, performance
- Context7: /pmndrs/drei - instances, controls, helpers
- Context7: /dimforge/rapier-js - physics setup, vehicle physics
...
- When the LLM's training data is likely stale or sparse
