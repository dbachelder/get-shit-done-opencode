...
**Key insight:** PLAN.md IS the prompt that the LLM executes. Not a document that
...
- Technology mentioned that the LLM hasn't used in THIS codebase
...
- LLM automated work needing visual/functional verification? → checkpoint:human-verify
...
See ~/.config/opencode/gsd/references/checkpoints.md for checkpoint structure and automation guidance.
</step>
...
See ~/.config/opencode/gsd/references/scope-estimation.md for complete splitting guidance and quality degradation analysis.
</step>
...
1. Yes - Continue
2. Adjust - Let me modify
3. Start over - Back to context gathering
...
1. [Approach A] - [tradeoff description]
2. [Approach B] - [tradeoff description]
3. Decide for me - Use your best judgment
...
Tasks are instructions for the LLM, not Jira tickets.
</anti_patterns>
