...
<opencode_note>
OpenCode maintains conversation history within a session automatically.
This workflow is for resuming across sessions or after context clears.
The .continue-here.md files and STATE.md provide cross-session memory
that complements OpenCode's in-session context.
</opencode_note>
