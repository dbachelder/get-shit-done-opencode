...
1. ~/.config/opencode/gsd/templates/roadmap.md (milestone-grouped format)
...
What should we call this milestone?

1. v[X.Y] Features - Adding new functionality
2. v[X.Y] Improvements - Enhancing existing features
3. v[X.Y] Fixes - Bug fixes and stability
4. v[X.Y] Refactor - Code quality and architecture
5. v[X.Y+1].0 [Major] - Major version bump
6. Other - Custom name
