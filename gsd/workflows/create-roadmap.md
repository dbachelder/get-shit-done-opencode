...
No brief found. Want to create one first, or proceed with roadmap?

1. Create brief first - Run `/gsd/new-project`
2. Proceed without brief - I'll gather quick context
...
1. Yes - Continue with roadmap creation
2. Review research first - Show me the research files
...
```bash
ls ~/.config/opencode/gsd/expertise/ 2>/dev/null
```
...
1. Yes - Include this domain expertise
2. See options - Show me available domains
3. None - Proceed without domain expertise
...
Reply with a number (comma-separate for multiple).
...
1. Yes - Continue
2. Adjust - Let me modify research flags
...
1. Yes - Continue
2. Adjust - Let me modify the phases
...
1. Create roadmap - I have enough context
