...
1. ~/.config/opencode/gsd/templates/milestone.md
2. ~/.config/opencode/gsd/templates/milestone-archive.md
...
Use template from `~/.config/opencode/gsd/templates/milestone.md`:
...
**Plan v[X.Y+1]** — Define scope for next milestone

**To discuss scope first:** `/gsd/discuss-milestone`
