...
<context7_note>
**OpenCode Integration:** When conducting research, use the Context7 MCP server for documentation lookups. Context7 provides access to up-to-date library documentation, reducing the risk of outdated information from web searches.

To use Context7:
1. Resolve library ID: `mcp__context7__resolve-library-id` with `libraryName`
2. Get documentation: `mcp__context7__get-library-docs` with resolved `context7CompatibleLibraryID`

This is particularly valuable for:
- Current API patterns and syntax
...
```xml
<sources>
Official sources (use Context7 MCP for library docs):
...
```xml
<verification_checklist>
□ Check current official documentation (use Context7 for libraries)
...
**Example**: "Claude Desktop supports X" ≠ "Claude Code supports X" ≠ "OpenCode supports X"
...
- [ ] Official documentation (primary) - use Context7 for libraries
...
- [ ] Context7 MCP used for library documentation lookups
